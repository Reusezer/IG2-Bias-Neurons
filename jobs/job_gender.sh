...
#PJM -g gb20
#PJM -j
#PJM -o ig2_gender_%j.out
#PJM --name ig2-gender
#PJM --mail-list ripitoaa@gmail.com
#PJM -m b,e

# Original IG² Analysis: Gender (female vs male)
...
echo "=============================================="
echo "Original IG² Analysis: Gender"
echo "=============================================="
echo "Model: ${MODEL}"
...
singularity exec --nv \
    ...
    "${CONTAINER}" python scripts/run_ig2.py \
        ...
        --d1 female \
        --d2 male \
        --output_dir "results/${MODEL}/gender_female_male" \
        --num_steps 50

echo ""
echo "=============================================="
echo "Gender Analysis Complete!"
echo "=============================================="
echo "End time: $(date)"
